...
public class rootFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
         ...
         * "real" fragment
         */
        transaction.replace(R.id.root_frame, byCategoryFragment.newInstance(mJsonCategory, mJsonLCategory));
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onFragmentInteractionFromRoot();
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteractionFromRoot();
    }
}
